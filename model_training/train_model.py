...
#         y = features_df['target_aqi_3day_avg']
...
#             self.save_model(rf_model, 'RandomForest', rf_metrics, feature_columns)
...
#             self.save_model(ridge_model, 'Ridge', ridge_metrics, feature_columns)
...
#             self.save_model(xgb_model, 'XGBoost', xgb_metrics, feature_columns)
...
#                 print(f"{result['model_name']}: RMSE={result['test_rmse']:.2f}, MAE={result['test_mae']:.2f}, R²={result['test_r2']:.3f}")
